...
func (s *PatientSuite) TestFHIRTransactionBundleConditionalUpdate(c *C) {
	...
	c.Assert(bundle.Entry[0].Resource, FitsTypeOf, &fhir.Patient{})
	patientID := bundle.Entry[0].Resource.(*fhir.Patient).Id
	patientRef := "Patient%2F" + patientID
	_ = patientRef
	for i := range bundle.Entry {
	...
	assertURL(c, bundle, 1, "Encounter?date=2011-11-01T08%3A00%3A00\u0026patient="+patientRef+"\u0026type=http%3A%2F%2Fwww.ama-assn.org%2Fgo%2Fcpt%7C99201")
	assertURL(c, bundle, 2, "Encounter?date=2012-10-01T08%3A00%3A00\u0026patient="+patientRef+"\u0026type=http%3A%2F%2Fwww.ama-assn.org%2Fgo%2Fcpt%7C99201")
	assertURL(c, bundle, 3, "Encounter?date=2012-11-01T08%3A00%3A00\u0026patient="+patientRef+"\u0026type=http%3A%2F%2Fwww.ama-assn.org%2Fgo%2Fcpt%7C99201")
	assertURL(c, bundle, 4, "Encounter?date=2012-11-01T08%3A45%3A00\u0026patient="+patientRef+"\u0026type=http%3A%2F%2Fsnomed.info%2Fsct%7C171047005")
	...
	assertURL(c, bundle, 10, "Observation?code=http%3A%2F%2Floinc.org%7C17856-6\u0026date=2011-11-01T08%3A16%3A40\u0026patient="+patientRef)
	assertURL(c, bundle, 11, "Procedure?code=http%3A%2F%2Fsnomed.info%2Fsct%7C116783008\u0026date=2011-11-01T08%3A16%3A40\u0026patient="+patientRef)
	assertURL(c, bundle, 12, "DiagnosticReport?code=http%3A%2F%2Floinc.org%7C59776-5\u0026date=2011-11-01T08%3A16%3A40\u0026patient="+patientRef)
	assertURL(c, bundle, 13, "Observation?code=http%3A%2F%2Fsnomed.info%2Fsct%7C116783008\u0026date=2011-11-01T08%3A16%3A40\u0026patient="+patientRef)
	assertURL(c, bundle, 14, "Observation?code=http%3A%2F%2Fsnomed.info%2Fsct%7C116783008\u0026date=2011-11-01T08%3A16%3A40\u0026patient="+patientRef)
	assertURL(c, bundle, 15, "Observation?code=http%3A%2F%2Fsnomed.info%2Fsct%7C116783008\u0026date=2011-11-01T08%3A16%3A40\u0026patient="+patientRef)
	assertURL(c, bundle, 16, "Procedure?code=http%3A%2F%2Fhl7.org%2Ffhir%2Fsid%2Ficd-10%7C0210093%2Chttp%3A%2F%2Fhl7.org%2Ffhir%2Fsid%2Ficd-9%7C36.10%2Chttp%3A%2F%2Fsnomed.info%2Fsct%7C10190003\u0026date=2013-03-02T10%3A45%3A00\u0026patient="+patientRef)
	assertURL(c, bundle, 17, "MedicationStatement?code=http%3A%2F%2Fwww.nlm.nih.gov%2Fresearch%2Fumls%2Frxnorm%2F%7C1000048\u0026effectivedate=2012-10-01T08%3A00%3A00\u0026patient="+patientRef)
	...
	assertURL(c, bundle, 20, "AllergyIntolerance?code=http%3A%2F%2Fwww2a.cdc.gov%2Fvaccines%2Fiis%2Fiisstandards%2Fvaccines.asp%3Frpt%3Dcvx%7C111\u0026onset=2012-01-01T00%3A42%3A00\u0026patient="+patientRef)
}
